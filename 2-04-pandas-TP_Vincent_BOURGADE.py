...
# votre code
df.loc[88]
#Aucune information n'est contenue dans la ligne 
...
# votre code
df.dtypes
#La colonne des masses est composée de string et non de flottants
...
# %%
# votre code
pd.Series(df['Mass (lb)']).unique()
# Les valeurs sont bien en str, ce qui permet d'afficher les signes supérieurs ou inferieurs pour ceratines cases
...
pd.to_numeric(np.array(pd.Series(df['Mass (lb)'])),errors='coerce')
df
